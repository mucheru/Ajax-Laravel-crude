          ...
          <table id="laravel_crud" class="table table-striped table-bordered">
            ...
            <tbody>
                ...
                <tr id="row_<?php echo e($post->id); ?>">
                   ...
                   <td><a href="javascript:void(0)" data-id="<?php echo e($post->id); ?>" onclick="editPost(event.target)" class="btn btn-info">Edit</a></td>
                   <td>
                    <a href="javascript:void(0)" data-id="<?php echo e($post->id); ?>" class="btn btn-danger" onclick="deletePost(event.target)">Delete</a></td>
                </tr>
...
</html><?php /**PATH /home/steve/ajax-crud/resources/views/posts.blade.php ENDPATH**/ ?>